    ...
    <nav className="main-menu navbar-expand-lg mobile-nav">
      <div className="navbar-header">
        <div className="mobile-logo my-15">
          <Link href="/">
            <a>
              <img src="https://www.arcelonutrifoods.com/wp-content/uploads/2020/08/Arcelo-Logo_TM.png" alt="Logo" title="Logo" />
              <img
                src="hhttps://5.imimg.com/data5/SELLER/Logo/2022/7/JK/LZ/HX/144520517/arcelo-logo-tm-90x90.png"
                alt="Logo"
                title="Logo"
              />
            </a>
          ...
          <div className="logo-outer">
            <div className="logo">
              <Link href="/">
                <a>
                  <img
                    src="https://5.imimg.com/data5/SELLER/Logo/2022/7/JK/LZ/HX/144520517/arcelo-logo-tm-90x90.png"
                    alt="Logo"
                    title="Logo"
                  />
                </a>
